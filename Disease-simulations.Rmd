...
```
Change 0s to min because the 0s might be a sampling artifact and it is not realistic the assume that because two monkeys were never observed in proximity they never were.
```{r}
